...
public class GPSTracker extends Service implements LocationListener {
    ...
    public GPSTracker(Context context) {
        ...
        getLocation();
        storeLocationToUtilities();
    }

    private void storeLocationToUtilities() {
        Utilities.location_longitude = (float)longitude;
                Utilities.location_latitude = (float)latitude;
...
Log.d("store val",Utilities.location_longitude + ","+Utilities.location_latitude);
    ...
    public void onLocationChanged(Location location) {
        ...
        Utilities.location_longitude = (float)location.getLongitude();
        Utilities.location_latitude = (float)location.getLatitude();
